### Profile
- **Education**
    - `German / Convergence Software, HUFS` 
- **Certifications**
    - `SQLD (SQL Developer)`
    - `Engineer Information Processing (Written Exam Passed)`
- **Activities**
    - `Software Maestro 17th` *<sub>( Apr 2026 ~ )</sub>*
...
| **NEXERP**     | Logistics ERP, <br/> Awarded Grand Prize in IT Club | FE, BE                     | [FE](https://github.com/kwak513/NEXERP-FE), [BE](https://github.com/kwak513/NEXERP-BE)                                                       |
