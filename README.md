### Profile
- **Education**
    - `한국외국어대학교 독일어 & 융복합소프트웨어 (German / Convergence Software, HUFS)` 
- **Certifications**
    - `SQLD (SQL Developer)`
    - `정보처리기사 필기 (Engineer Information Processing - Written)`
- **Activities**
    - `KT 대학생 IT 서포터즈 3기 (KT IT Supporters)`
    - `TAVE 코딩 연합동아리 16기 (TAVE IT Club)`
